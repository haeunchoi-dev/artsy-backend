...
export class Database {
  ...
  public async excuteQuery(callbackFn: (connection: promiseMysql.PoolConnection) => Promise<any>) {
  ...
  public async excuteQueryWithTransaction(callbackFn: (connection: promiseMysql.PoolConnection) => Promise<any>) {
    let connection: promiseMysql.PoolConnection | null = null;
